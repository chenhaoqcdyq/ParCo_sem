...
class JointAttention(nn.Module):
    def __init__(self, dim, num_heads=8, dropout=0.0, spatial_first=True, causal=False):
        super().__init__()
        self.dim = dim
        self.num_heads = num_heads
        self.head_dim = dim // num_heads
    ...
    def _apply_temporal_attention(self, x):
        ...
        if self.causal:
            ...
            temporal_out, _ = self.temporal_attention(temp_x, temp_x, temp_x, attn_mask=causal_mask)
        else:
            # Apply attention
