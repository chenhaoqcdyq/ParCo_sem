...
import utils.eval_bodypart as eval_bodypart_outputs
from utils.word_vectorizer import WordVectorizer
from models import lgvq
...
avg_gsa_loss, avg_mtp_loss, avg_ras_loss = 0., 0., 0.
...
for nb_iter in range(1, args.warm_up_iter):
    ...
    avg_gsa_loss += loss_lgvq['gsa_loss']
    avg_mtp_loss += loss_lgvq['mtp_loss']
    avg_ras_loss += loss_lgvq['ras_loss']
...
best_fid, best_iter, best_div, best_top1, best_top2, best_top3, best_matching, writer, logger = \
    eval_bodypart_outputs.evaluation_vqvae(
